...
\begin{theorem}[Gershgoring Theorem]
...
\[
    Z_i = \{z_i\in\R^{n_i}|z_i\in\{0,1\}, \displaystyle\sum_{k=1}^{N}{z_i}_k=1\} % TODO check recording
\]
Suppose each robot can serve all tasks. then
\[
...
\begin{theorem}[Distributed Dual Subgradient]
    Let Assumptions 1, 2, and 3d hold.
\end{theorem}
